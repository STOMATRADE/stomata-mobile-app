...
part of 'portofolio_summary_view_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PortofolioSummaryViewModel _$PortofolioSummaryViewModelFromJson(
  ...
  investments: (json['investments'] as List<dynamic>?)
      ?.map((e) => PortofolioItemViewModel.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$PortofolioSummaryViewModelToJson(
  PortofolioSummaryViewModel instance,
) => <String, dynamic>{
  'id': instance.id,
